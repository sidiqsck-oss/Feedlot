...
<div class="grid gap-5 lg:grid-cols-3">
    ...
    {{-- Form unggah --}}
    <form method="POST" action="{{ route('impor.store') }}" enctype="multipart/form-data" class="kartu p-4 lg:col-span-2">
        @csrf
    ...
    <div class="space-y-4">
        ...
        <div class="kartu p-4">
            ...
            <p class="mt-1 text-sm text-ink-soft">
                Impor <strong>induksi dulu</strong>, baru reweight. Data reweight menempel ke sapi yang
                sudah tercatat induksinya — kalau induksinya belum ada, semua barisnya akan ditolak.
            </p>
        </div>
    </div>
</div>
